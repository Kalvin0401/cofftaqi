<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-xl font-semibold">Stok Keluar</h1>
    ...
    <div class="inline-flex items-center gap-1.5 bg-white dark:bg-zinc-900 rounded-full px-3 py-1.5 w-36 transition" style="border: 2px solid #4F8B6A;">
        ...
        <input
            ...
            placeholder="Cari kopi, tanggal, tujuan..."
        ...
        <table class="w-full text-sm">
            ...
            <thead style="background-color: #D0E5D8;">
                <tr style="border-bottom: 2px solid #7dba9a;">
                    ...
                    <th class="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider" style="color: #2A5240; border-right: 1px solid #7dba9a;">Tujuan</th>
                    ...
                    <tr
                        ...
                        <td class="px-4 py-3">
                            <div class="flex justify-center gap-1">
                                ...
                                {{-- Tombol Edit --}}
                                <a href="{{ route('gudang.stok-keluar.edit', $row->id) }}">
                                    <button
                                        title="Edit"
