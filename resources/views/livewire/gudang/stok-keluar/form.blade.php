<div class="max-w-2xl mx-auto" style="padding-bottom: 24px;">
    ...
    <div style="display:flex; align-items:center; gap:8px; margin-bottom:14px;">
        <div style="background-color:#fef2f2; width:32px; height:32px; border-radius:8px; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
            <svg xmlns="http://www.w3.org/2000/svg" style="width:15px;height:15px;" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#991b1b">
        ...
        <div>
            <h1 style="font-size:1rem; font-weight:700; margin:0; color:#111827; line-height:1.3;">
                {{ $stokKeluarId ? 'Edit Stok Keluar' : 'Tambah Stok Keluar' }}
            </h1>
            <p style="font-size:0.72rem; color:#9ca3af; margin:1px 0 0 0;">
                {{ $stokKeluarId ? 'Perbarui data pengiriman kopi' : 'Catat pengiriman kopi dari gudang' }}
            </p>
        </div>
    </div>
    ...
    <form wire:submit.prevent="save">
        ...
        <div style="background:#fff; border:1.5px solid #e5e7eb; border-radius:10px; padding:14px 16px; margin-bottom:8px;">
                ...
                <div style="display:table-cell; width:50%; vertical-align:top;">
                    ...
                    <flux:input
                        ...
                        x-init="
                            ...
                            $watch('$wire.harga_perkilo', value => {
                                if (value !== undefined && value !== null) {
                                    $el.value = new Intl.NumberFormat('id-ID').format(value);
                                }
                            });
            ...
            {{-- TOTAL BOX - soft red --}}
            <div style="background:#fef2f2; border:1px solid #fecaca; border-radius:8px; padding:9px 14px; display:flex; align-items:center; justify-content:space-between;">
                <div>
                    <div style="font-size:0.7rem; color:#991b1b; font-weight:600;">Total nilai</div>
                    <div style="font-size:0.62rem; color:#fca5a5;">Jumlah × harga per kg</div>
                </div>
                <div style="font-size:1.05rem; font-weight:700; color:#dc2626; letter-spacing:-0.3px;">
                    Rp {{ number_format($total, 0, ',', '.') }}
                </div>
            </div>
        </div>

        {{-- SECTION 3: TUJUAN & KETERANGAN --}}
        <div style="background:#fff; border:1.5px solid #e5e7eb; border-radius:10px; padding:14px 16px; margin-bottom:14px;">
            <div style="display:flex; align-items:center; gap:5px; margin-bottom:12px; padding-bottom:9px; border-bottom:1px solid #f3f4f6;">
                ...
                <span style="font-size:0.65rem; font-weight:700; color:#4b5563; letter-spacing:0.07em; text-transform:uppercase;">Tujuan & Keterangan</span>
            </div>
            <div style="display:table; width:100%; border-collapse:separate; border-spacing:12px 0; margin-bottom:10px;">
                <div style="display:table-cell; width:50%; vertical-align:top;">
                    <label style="display:block; font-size:0.73rem; font-weight:600; color:#374151; margin-bottom:4px;">Tujuan <span style="color:#ef4444;">*</span></label>
                    <flux:input wire:model="tujuan" placeholder="Nama pembeli / tujuan pengiriman..." />
                </div>
                <div style="display:table-cell; width:50%; vertical-align:top;">
                    <label style="display:block; font-size:0.73rem; font-weight:600; color:#374151; margin-bottom:4px;">Keterangan</label>
                    <flux:input wire:model="keterangan" placeholder="Catatan tambahan..." />
                </div>
            </div>
        </div>
